...
alter table car_table modify price int default null;

alter table car_table modify car_id int(11) not null auto_increment first;

desc car_table;

select * from car_table;

update car_table set price = 3500;
